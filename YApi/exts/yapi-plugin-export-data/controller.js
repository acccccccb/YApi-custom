...
class exportController extends baseController {
  ...
  async exportData(ctx) {
    ...
    async function createHtml(list) {
      ...
      return createHtml5(left || '', content, list);
    }

    function createHtml5(left, tp, list) {
      //html5模板
      ...
      <script src="https://lib.baomitu.com/zTree.v3/3.5.42/js/jquery.ztree.core.min.js"></script>
      <link rel="stylesheet" href="https://lib.baomitu.com/zTree.v3/3.5.42/css/zTreeStyle/zTreeStyle.min.css" >
      <meta charset="utf-8" />
      ${defaultTheme}
      </head>
      <style>
      ...
      <body>
        ...
        <script>
          ...
          var setting = {
            ...
            callback: {
              onClick: (event, treeId, treeNode) => {
                const id = $('#' + treeNode.name).parents('h2')[0].id;
          ...
          $(document).ready(function(){
            const tree = $.fn.zTree.init($("#tree"), setting, list);
            tree.expandAll(true);
          });
        </script>
        </body>
